  ...
  return (
    <div className="h-screen w-screen flex flex-col overflow-hidden bg-background islamic-pattern p-[0.75vw] gap-[0.75vw]">
      ...
      <div className="flex-1 flex gap-[0.5vw] min-h-0 px-[0.5vw]">
        <div className="w-[24%] bg-white rounded-xl shadow-md p-[0.5vw] flex flex-col relative overflow-hidden shrink-0">
          <DisplaySidebarLeft />
        </div>
        <div className="flex-1 h-full aspect-video shrink-0 overflow-hidden flex items-center justify-center">
          <MainContent />
        </div>
